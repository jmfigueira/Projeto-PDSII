...
namespace Plot
{
    public partial class PlotUC : UserControl
    {

        public Figura fig = new Plot.Figura(123, 123);
        ...
        public PlotUC()
        {
            ...
            fig.styleForm();
            fig.Zoom(.8, .8);
            fig.labelTitle = "Plotagem - Controle do usuário";
        }
        ...
        /// <summary>
        /// Force Plot to redraw itself. This is helpful after changing axis limits or labels.
        /// </summary>
        public void Redraw()
        {
            pictureBox1_SizeChanged(null, null);
